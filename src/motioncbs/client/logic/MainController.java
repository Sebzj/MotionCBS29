...
public class MainController {
    ...
    //Opretter objekter af contentpanel
    ...
    class LoginClickHandler implements ClickHandler {
        ...
        public void onClick(ClickEvent event) {
            ...
            motionCBSService.authorizeUser(username, password, new AsyncCallback<User>() {
                ...
                /*
                 * Håndterer sucess fra call back funktionen og derefte returner en user
                 */
                @Override
                public void onSuccess(User user) {
                    // brugeren får besked hvis indtastede ikke findes / passer
                    if (user == null) {
                        Window.alert("Wrong username or password");
                    } else {

                        // rydder felterne så man kan indtaste igen
                        content.getLoginView().clearTextBox();

                        /*
                         * 1) Indtastede findes i databasen
                         * 2) Tjekker hvorvidt det er en admin eller user der logger ind ved brug af customertype
                         * 3) Viderestiller til hhv. admin- eller user-siden.
                         */
